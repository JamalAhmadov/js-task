...
function findBYID(id) {
    console.log(myArray.find(item => item.id === id).shipAddress.country);    
}
...
function findObyekt(x) {
  console.log(myArray.find((item) => item.shipAddress.country == x));
}
findObyekt("Switzerland");

// 3.

    function findElement(id) {
    let element = myArray.find(item=>item.id===id);
    console.log(element.shipName);
    console.log(element.shipAddress.country);
    console.log(element.shipAddress.city);   
}
findElement(11072);

// 4.

      function findSatis(id) {
      let element=myArray.find(item=>item.id===id);
